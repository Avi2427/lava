...
module.exports = {
    ...
    run: async(client, message, args, cmduser, text, prefix) => {
        ...
        if (message.content.includes("youtu")) {
            //send searching
            message.channel.send(`<:youtube:840503173331419166> **Searching** :mag_right: \`${args.join(" ")}\``)
            ...
            //send searching
            message.channel.send(`<:spotify:840503246572355624>**Searching** :mag_right: \`${args.join(" ")}\``)
                //play the song from our playermanager
            playermanager(client, message, args, `play:youtube`);
